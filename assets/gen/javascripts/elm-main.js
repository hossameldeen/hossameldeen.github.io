...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Main$model, _1: _user$project$Main$initialSizeCmd},
		update: _user$project$Main$update,
		subscriptions: _user$project$Main$subscriptions,
		view: _user$project$Main$view
	})();
var _user$project$Main$Model = {};
var _user$project$Main$NoMsgTypeYet = {ctor: 'NoMsgTypeYet'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"NoMsgTypeYet":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
